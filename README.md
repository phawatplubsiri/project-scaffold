...
```powershell
irm https://raw.githubusercontent.com/phawatplubsiri/project-scaffold/main/init-agents-monorepo.ps1 | iex
```

## For Polyrepo (FE & BE separate repos)
```powershell
irm https://raw.githubusercontent.com/phawatplubsiri/project-scaffold/main/init-agents-multirepo.ps1 | iex
```
